...
<body>
	...
	<!-- 구매 회원 메인 페이지의 가게 -->
	<h6 class="subtitle">
		가게 <a href="${pageContext.request.contextPath}/searchShop.do" class="float-right small">가게 더보기</a>
	</h6>
	<div class="row">
		...
		<div class="row">
			<div class="col text-center">
				...
				<p class="text-secondary">
					YouShoes는 통신판매중개자이며, 통신판매의 당사자가 아닙니다.
					<br>
					따라서 YouShoes는 상품거래 정보 및 거래에 대한 책임을 지지 않습니다.
				</p>
			</div>
		</div>
	</div>
