	...
	<section class="page-section" id="services">
		<div class="container">
			...
			<div class="row text-center">
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-shopping-cart fa-stack-1x fa-inverse"></i>
					</span>
					<h4 class="service-heading">E-Commerce</h4>
					<p class="text-muted">당신만을 위한 수제화를 장인들이 제작합니다.</p>
				</div>
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-laptop fa-stack-1x fa-inverse"></i>
					</span>
					<h4 class="service-heading">Online</h4>
					<p class="text-muted">모든 제품들은 온라인으로 주문할 수 있습니다.</p>
				</div>
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-lock fa-stack-1x fa-inverse"></i>
					</span>
	...
	<section class="page-section" id="about">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="timeline">
						<li><img class="rounded-circle img-fluid" src="${contextPath}/view/img/about/home1.jpg" alt="">
						...
						<li class="timeline-inverted"><img class="rounded-circle img-fluid" src="${contextPath}/view/img/about/home2.png" alt="">
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4>2014~</h4>
						...
						<li><img class="rounded-circle img-fluid" src="${contextPath}/view/img/about/home3.jpg" alt="">
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4>현대의 수제화 골목</h4>
								</div>
						...
						<li><img class="rounded-circle img-fluid" src="${contextPath}/view/img/about/home4.png" alt="">
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4>YouShoes</h4>
								</div>
								<div class="timeline-body">
									<p class="text-muted">이 점을 해결하기 위해 YouShoes는 대구수제화 골목의 발전과활성화를위해 창안되었습니다.</p>
								</div>
							</div></li>
					</ul>
				</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="team-member">
						...
						<h4>구교동</h4>
						<p class="text-muted">Leader, 주문, 후기, 담당</p>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle" src="${contextPath}/view/img/team/2.jpg" alt="">
						<h4>권우성</h4>
						<p class="text-muted">member, 판매자 예약, 배송 담당</p>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle" src="${contextPath}/view/img/team/2.jpg" alt="">
						<h4>배광준</h4>
						<p class="text-muted">member, 로그인, 메인페이지, 관리자 판매회원 담당</p>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle" src="${contextPath}/view/img/team/2.jpg" alt="">
						<h4>유승우</h4>
						<p class="text-muted">member, 프로필, 결제, 통계 담당</p>
					</div>
				</div>
			</div>
		</div>
