			...
			<div class="col-12">
				<div class="card shadow-sm border-0 mb-3">
					<div class="card-header">
						<div class="row">
							<div class="col">
								<h5 class="card-title">개인정보 약관</h5>
							</div>
						</div>
					</div>
					<div class="card-body">
						<table border="1" class="table">
							...
							<tbody>
								...
								<tr>
									<td>
										계약이행 및 약관변경 등의 고지를 위한 연락, 본인의사<br />확인및 민원 등의 고객불만처리
									</td>
									<td>이름, 아이디, 휴대폰번호, 이메일주소, 전화번호, 주소</td>
								</tr>
								<tr>
									<td>
										부정이용방지, 비인가사용방지, 서비스 제공 및 계약의 <br />이행
									</td>
								...
								<tr>
									...
									<td>
										<span>ID</span>, 휴대폰번호, 이메일주소, 전화번호, 생년월일, 부정거<br>래사유, 탈퇴 시 회원 상태값
									</td>
								</tr>
							</tbody>
						</table>
