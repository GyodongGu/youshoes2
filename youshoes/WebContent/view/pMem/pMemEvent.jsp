...
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			<!-- 아코디언 -->
			<div id="accordion">
				<c:forEach items="${pmemEvent}" var="pMemEvent" varStatus="status">
					<div>
						<span class="num">${status.count}</span> <span class="title">${pMemEvent.notice_title}</span> <span class="date">${pMemEvent.notice_date}</span>
					</div>
					  <div>
